...
var dilSec = '';
//hangi dil?
dilSec = dUrl.indexOf('_en') > -1 || dUrl.indexOf('_ar') > -1 ? 'en' : 'tr';

var hs = {
// Language strings
lang : {
    cssDirection: 'ltr',
	loadingText : (dilSec=='en')?'Loading...':'Yükleniyor...',
	loadingTitle : (dilSec=='en')?'Click to cancel':'Ýptal etmek için týklayýn',
	focusTitle : (dilSec=='en')?'Click to bring to front':'Öne getirmek için týklayýn',
	fullExpandTitle : (dilSec=='en')?'Expand to actual size (f)':'Gerçek boyutuna geniþletin (f)',
	creditsText : '', //'Powered by <i>Highslide JS</i>',
	creditsTitle : 'Go to the Highslide JS homepage',
	previousText : (dilSec=='en')?'Previous':'Önceki',
	nextText : (dilSec=='en')?'Next':'Sonraki', 
	moveText : (dilSec=='en')?'Move':'Taþý',
	closeText : (dilSec=='en')?'Close':'Kapat', 
	closeTitle : (dilSec=='en')?'Close (esc)':'Kapat (esc)', 
	resizeTitle : (dilSec=='en')?'Resize':'Boyutlandýr',
	playText : (dilSec=='en')?'Play':'Oynat',
	playTitle : (dilSec=='en')?'Play slideshow (spacebar)':'Slayt gösterisini baþlat (boþluk tuþu)',
	pauseText : (dilSec=='en')?'Pause':'Duraklat',
	pauseTitle : (dilSec=='en')?'Pause slideshow (spacebar)':'Slayt gösterisini duraklat (boþluk tuþu)',
	previousTitle : (dilSec=='en')?'Previous (arrow left)':'Önceki (sol ok tuþu)',
	nextTitle : (dilSec=='en')?'Next (arrow right)':'Sonraki (sað ok tuþu)',
	moveTitle : (dilSec=='en')?'Move':'Taþý',
	fullExpandText : (dilSec=='en')?'Full size':'Tam boy',
	number: (dilSec=='en')?'Photo %1 of %2':'Fotoðraf: %1 / %2',
	restoreTitle : (dilSec=='en')?'Click to close photo, click and drag to move. Use arrow keys for next and previous.':'Fotoðrafý kapatmak için týklayýn, taþýmak için týklayýn ve sürükleyin. Önceki ve sonrakiler için ok tuþlarýný kullanýn.'
},
